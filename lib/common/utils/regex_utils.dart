...
class RegexUtils {
  ...
  static readRegexFile() async {
    return FileUtils.readAsString("");
  }

  static sample() {
    const text = """My website url: https://blasanka.github.io/
...
stackoverflow.com is my greatest website. DartPad share: https://github.com/dart-lang/dart-pad/wiki/Sharing-Guide see this example and edit it here https://dartpad.dev/3d547fa15849f9794b7dbb8627499b00""";
    ...
    for (var match in matches) {
      MyLogger.info("sample regex: ${text.substring(match.start, match.end)}");
    }
  }
}
